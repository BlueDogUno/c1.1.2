...
#define HIGH_OPEN_RC_SCALE 200.0f // 遥控器乘以该比例发送到can上

//选择取矿机构状态 开关通道号
#define HIGH_MODE_CHANNEL 0

#define ANGLE_ERR_TOLERANT 2.0f

//抬升电机id
#define CAN_HIGH_L_MOTOR 0
#define CAN_HIGH_R_MOTOR 1


//抬升前电机速度环PID                           //主要是晃动明显
#define MOTIVE_MOTOR_SPEED_PID_KP 1500.0f
#define MOTIVE_MOTOR_SPEED_PID_KI 200.0f
// #define MOTIVE_MOTOR_SPEED_PID_KP 500.0f
...
//抬升后电机速度环PID                           //这边阻力很大
#define HIGH_B_MOTOR_SPEED_PID_KP 1500.0f
#define HIGH_B_MOTOR_SPEED_PID_KI 300.0f
#define HIGH_B_MOTOR_SPEED_PID_KD 0.0f
#define HIGH_B_MOTOR_SPEED_PID_MAX_IOUT 8000.0f
#define HIGH_B_MOTOR_SPEED_PID_MAX_OUT 12000.0f

//抬升后电机角度环PID
#define HIGH_B_MOTOR_ANGLE_PID_KP 1.0f 
#define HIGH_B_MOTOR_ANGLE_PID_KI 0.0f
#define HIGH_B_MOTOR_ANGLE_PID_KD 0.0f
#define HIGH_B_MOTOR_ANGLE_PID_MAX_IOUT 1.0f
#define HIGH_B_MOTOR_ANGLE_PID_MAX_OUT 100.0f
...
#define HIGH_INIT_LEN 75.0f
#define HIGH_SKY_LEN (HIGH_STANDARD_LEN + 200.0f)
#define HIGH_STANDARD_LEN 530.0f
#define HIGH_GROUND_LEN 0.0f
#define HIGH_DELIVERY_LEN 0.0f
